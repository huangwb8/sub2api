export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      oversell: {
        ...
        result: {
          ...
          priceGapHint: '与达标单价差额 {gap}',
          residentialIpCostHint: '近 {days} 天约 {traffic} GB · {users} 人 · 汇率 {fx}',
    ...
    proxies: {
      ...
      failoverSettingsSaved: '代理自动容错设置已保存',
      failoverSettingsSaveFailed: '保存代理自动容错设置失败',
      failoverFields: {
        enabled: '启用自动容错',
    ...
    schedulingMechanisms: {
      title: '调度机制',
      description: '统一管理全局临时不可调度规则与代理自动容错策略。',
      proxyFailoverEyebrow: '代理自动容错',
      proxyFailoverTitle: '自动巡检、隔离与迁移',
      proxyFailoverDescription: '这里定义代理级故障的巡检节奏、连续失败门槛、迁移负载上限与兜底冷却时间。',
      proxyFailoverHint: '建议先导入内置规则，再按你的代理池规模微调这些参数。',
      saveProxyFailover: '保存代理自动容错',
      proxyFailoverSaved: '代理自动容错设置已保存',
      importButton: '导入规则',
