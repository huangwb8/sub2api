export default {
  ...
  auth: {
    ...
    turnstileInvalid: '验证已失效，请重新完成验证后登录',
  ...
  profile: {
    ...
    avatar: {
      source: '头像来源',
      generated: '默认头像',
      generatedDescription: '使用站内生成的安全头像',
      uploaded: '上传头像',
      uploadedDescription: '使用本地 JPG、PNG 或 WebP 图片',
      external: '外链头像',
      externalDescription: '使用已有 CDN 或图床图片',
      externalUrl: '外链头像地址',
      uploadFile: '上传图片',
      uploadHint: '支持 JPG、PNG、WebP，文件大小不超过 1MB。',
      chooseFile: '选择图片',
      cropHint: '拖动图片调整位置，使用滑杆缩放；头像会保存为居中的方形图片。',
      zoom: '缩放',
      applyCrop: '应用裁剪',
      resetCrop: '居中重置',
      recenter: '重新居中',
      removeUpload: '移除图片',
      style: '默认头像风格',
      styleHint: '切换回默认头像时会使用这里的风格。',
      useGenerated: '使用默认头像',
      urlRequired: '请输入外链头像地址',
      fileRequired: '请选择要上传的头像图片',
      fileTooLarge: '头像图片不能超过 1MB',
      unsupportedFile: '头像图片仅支持 JPG、PNG 或 WebP',
      styles: {
        classicLetter: '经典首字母',
        classicLetterDesc: '稳妥清晰',
        auroraRing: '极光环',
        auroraRingDesc: '柔和光晕',
        orbitBurst: '轨道脉冲',
        orbitBurstDesc: '科技徽章',
  ...
  admin: {
    ...
    dashboard: {
      ...
      recommendations: {
        title: '加号推荐',
        description: '基于近 30 天全站负载与容量池状态，给出“建议补充可调度账号”的整改建议。',
        pool: '容量池',
        contributors: '涉及套餐',
        status: '状态',
        current: '当前可调度 / 总账号',
        ...
        utilization: '容量利用率',
        reason: '推荐理由',
        poolsAndGroups: '评估 {pools} 个容量池 / {groups} 个订阅分组',
        toAddSchedulable: '全站建议补充 {count} 个可调度账号',
        recoverable: '可优先恢复现有不可调度账号 {count} 个',
        urgent: '需优先处理 {count} 个容量池',
        subscriptions: '{count} 个活跃订阅',
        addSchedulableCount: '建议补充 {count} 个可调度账号',
        recoverableInline: '可先恢复 {count} 个不可调度账号',
        newAccountsInline: '预计新增 {count} 个账号',
        noAction: '当前容量健康，无需补号',
        projectedCost: '预计日负载 ${amount}',
        empty: '暂未形成可执行的容量池建议。',
        statusMap: {
          healthy: '健康',
          watch: '观察',
      ...
      oversell: {
        ...
        tooltips: {
          ...
          residentialIpPrice: '按住宅代理供应商的计费口径填写单价，单位为 美元 / (GB*月)。系统会把这个单价直接应用到最近样本校准后的住宅 IP 月流量估算，并按现有汇率机制换算成人民币。',
        ...
        result: {
          ...
          priceGapHint: '与达标单价差额 {gap}',
          residentialIpTraffic: '预计需 {traffic} GB/月',
          residentialIpCostHint: '按近 {days} 天样本人均流量折算 · 约 {traffic} GB · {users} 人 · 汇率 {fx}',
          revenueHint: '月收入 ¥{value}',
          costHint: '保守月成本 ¥{value}',
          residentialIpScopeHint: '当前结果口径：{scope} · 包含管理员：{includesAdmin}',
          residentialIpCalibrationHint: '校准系数 {bytes} Bytes/token · 来源 {source}',
          note: 'Hoeffding 上界用于估算在给定把握度下，用户池人均消耗超出可承受阈值的风险。',
          users: '{count} 人'
        },
        residentialIpScopeTitle: '住宅 IP 双口径说明',
        residentialIpScopeDescription: '套餐定价口径用于推导对外售价，站点口径用于观察真实基础设施开销。两者应并行查看，避免把定价估算误当成站点真实账单。',
        reconciliationSummary: '最近对账样本：系统估算 {estimated} GB，对应供应商账单 {supplier} GB，误差 {error}',
        scopePricing: '套餐定价口径',
        scopeSite: '站点真实成本口径',
        scopePricingDescription: '默认排除管理员，仅面向用户成功请求，用于套餐定价和利润测算。',
        scopeSiteDescription: '包含管理员流量，用于观察站点近期真实住宅代理成本。',
        scopeTraffic: '窗口总流量',
        scopeMonthlyCost: '折算月成本',
        scopeUsers: '涉及用户',
        scopeAdmin: '包含管理员',
        scopeTrafficBasisHint: '流量基础：{basis} · 校准来源：{calibration}',
        table: {
          title: '套餐价格换算',
          plan: '套餐',
          basis: '权益规模 / 测算依据',
    ...
    users: {
      ...
      riskCenter: '风控中心',
      riskDialog: '风控详情',
      riskDialogTitle: '风控详情 · {email}',
      riskScore: '风险分',
      riskState: '风险状态',
      riskBadDays: '连续异常天数',
      riskLastWarned: '最近警告',
      riskSummary: '评估摘要',
      noRiskSummary: '暂无风控摘要',
      riskSignals: '最近信号',
      riskTrustedIPs: '可信公网 IP',
      riskUserAgents: 'UA 家族',
      riskApiKeys: 'API Key 数',
      riskOverlapEvents: '重叠事件',
      riskRecentIPs: '最近 IP',
      riskRecentUAs: '最近 UA',
      riskEvents: '风险事件',
      noRiskEvents: '暂无风险事件',
      riskRefresh: '刷新详情',
      riskActions: '管理员操作',
      riskActionsHint: '这里的操作不会影响余额、分组或订阅，仅针对转售风控档案。',
      riskActionReason: '操作备注',
      riskActionReasonPlaceholder: '例如：用户解释为团队共用场景，先解除锁定继续观察',
      riskExemptionToggle: '更新豁免状态',
      riskExemptionToggleHint: '勾选表示启用豁免，取消勾选表示移除豁免。',
      riskSendWarning: '发送警告邮件',
      riskUnlock: '解除锁定',
      riskExempt: '保存豁免',
      riskRemoveExemption: '移除豁免',
      riskResetScore: '重置风险分',
      riskWarningSent: '风险警告已发送',
      riskUnlocked: '风险锁定已解除',
      riskExemptionUpdated: '风险豁免状态已更新',
      riskScoreReset: '风险分已重置',
      riskFailedToLoad: '加载风险详情失败',
      riskActionFailed: '执行风险操作失败',
      riskStatuses: {
        healthy: '正常',
        observed: '观察中',
        warned: '已警告',
    ...
    accounts: {
      ...
      tempUnschedulable: {
        ...
        selectMechanismRulePlaceholder: '选择已配置规则',
        selectMechanismRuleHint: '仅可选择调度机制中已启用、且与当前账号平台和类型匹配的规则。',
        noMechanismRules: '暂无可用于当前账号的调度机制规则，请先在“调度机制”界面配置并启用规则。',
        noSelectedMechanismRules: '请从上方下拉列表选择至少一条规则。',
        addRule: '添加规则',
        ruleOrder: '规则序号',
        ruleIndex: '规则 #{index}',
        errorCode: '错误码',
        ...
        rulesInvalid: '请至少从调度机制中选择一条可用规则。',
      ...
      bulkEdit: {
        ...
        filteredInfo: '将按当前筛选结果更新 {count} 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
      ...
      openai: {
        ...
        chatAPIResponsesEnabled: '同时服务 Responses API',
        chatAPIResponsesEnabledDesc:
          '开启后，此 ChatAPI 账号也可被调度用于 Responses API 请求。仅在上游代理支持 Responses API 格式时开启。',
    ...
    proxies: {
      ...
      reliabilityTitle: '巡检与真实请求关联',
      probeSuccessRate: '巡检成功率',
      realSuccessCount: '真实成功请求',
      afterFailureWindow: '失败后 {minutes} 分钟真实成功',
      reliabilityHint: '巡检失败是风险信号，不等同于真实请求必失败。',
      noReliabilityData: '暂无巡检关联数据',
      ...
      failoverSettingsSaveFailed: '保存巡检设置失败',
      failoverFields: {
        enabled: '启用自动容错',
    ...
    schedulingMechanisms: {
      ...
      proxyFailoverHint: '',
      saveProxyFailover: '保存巡检设置',
      proxyFailoverSaved: '巡检设置已保存',
      importButton: '导入规则',
      importHint: '可直接导入仓库中的 `docs/rules/调度机制.json`，也支持你自己的 JSON 批量规则文件。',
      importSuccess: '调度机制导入成功',
      importFailed: '导入调度机制失败',
      saveFailed: '保存调度机制失败',
      createButton: '新建机制',
      createDialogTitle: '新建调度机制',
      editDialogTitle: '编辑调度机制',
      searchPlaceholder: '搜索机制名称、平台或账号类型',
      showHidden: '显示已隐藏机制',
      enabled: '启用中',
      disabled: '已停用',
      hidden: '已隐藏',
      ...
      hideAction: '隐藏',
      showAction: '取消隐藏',
      mechanismSaved: '调度机制已保存',
      mechanismDeleted: '调度机制已删除',
      mechanismHidden: '调度机制已隐藏',
      mechanismShown: '调度机制已恢复显示',
      backToProxies: '返回 IP 管理',
      ruleCount: '{count} 条规则',
      emptyTitle: '暂无调度机制',
      emptyDescription: '先导入内置规则，或新建一组自己的临时不可调度策略。',
      columns: {
        name: '机制',
        scope: '作用范围',
        status: '状态',
      ...
      scope: {
        platformAll: '全部平台',
        accountTypeAll: '全部账号类型'
      },
      fields: {
        enabled: '总开关',
        autoTestEnabled: '自动巡检',
        probeIntervalMinutes: '巡检间隔（分钟）',
      ...
      form: {
        ...
        description: '说明',
        rules: '临时不可调度规则',
        rulesHint: '关键词用英文逗号分隔；命中 HTTP 状态码且任一关键词出现时触发。',
        errorCode: 'HTTP 状态码',
        durationMinutes: '冷却分钟数',
        keywords: '关键词',
        keywordsPlaceholder: 'bad gateway, upstream, overloaded',
        ruleDescription: '规则说明',
        validationFailed: '请至少填写机制名称和一条有效规则'
      },
      addRule: '新增规则'
    },
    ...
    redeem: {
      ...
      invitation_balance: '邀请码（余额）',
      invitationBalanceHint: '余额邀请码用于限制用户注册，使用后自动标记为已使用，并在新用户默认余额基础上增加配置金额；该金额按人民币（CNY）计入用户余额。',
      allTypes: '全部类型',
      allStatus: '全部状态',
      unused: '未使用',
      used: '已使用',
    ...
    settings: {
      ...
      defaults: {
        ...
        subscriptionCapacityTightness: '额度紧张度',
        subscriptionCapacityTightnessHint: '控制管理员对补号建议的风险偏好。值越大，系统越倾向于提前推荐补充更多账号来降低超卖风险；值越小，则更强调成本克制，但仍会保留安全下限以避免明显容量事故。',
        subscriptionCapacityTightnessLow: '更克制',
        subscriptionCapacityTightnessHigh: '更保守',
      ...
      webSearchEmulation: {
        title: 'WebSearch 模拟',
        description: '为 Anthropic API Key 请求配置全局 WebSearch 模拟能力，默认关闭，仅在显式启用后生效。',
        enabled: '启用 WebSearch 模拟',
        enabledHint: '仅当请求只包含 WebSearch 工具时生效，不会干扰你现有的普通转发链路。',
        providers: '搜索提供商',
        addProvider: '添加提供商',
        noProviders: '尚未配置任何搜索提供商',
        providerType: '提供商类型',
        apiKey: 'API Key',
        ...
        copied: '已复制',
        quotaLimit: '配额上限',
        quotaLimitHint: '留空表示不限额；配置后将按月度配额统计使用量。',
        quotaLimitMustBePositive: '配额上限必须为正整数，或留空表示不限额。',
        subscribedAt: '订阅开始日期',
        subscribedAtHint: '用于月度配额重置时间的计算。',
        expiresAt: '到期日期',
        quotaUsage: '已用配额',
        resetUsage: '重置已用配额',
        resetUsageConfirm: '确定要将该提供商的已用配额重置为 0 吗？',
        resetUsageSuccess: '已重置配额使用量',
        proxy: '绑定代理',
        test: '测试',
        testing: '测试中...',
        testResultTitle: 'WebSearch 测试结果',
        testResultProvider: '命中提供商',
        testNoResults: '未返回搜索结果',
      ...
      site: {
        ...
        appearanceDescription: '设置当前浏览器的后台与公开页面主题显示方式',
        themeMode: '主题模式',
        themeModeHint: '设置会立即生效，并保存在当前浏览器。',
        themeModeSystem: '跟随系统',
        themeModeLight: '浅色模式',
        themeModeDark: '深色模式',
        themeModeSchedule: '按时间自动切换',
        themeDarkStart: '深色开始',
        themeDarkEnd: '深色结束',
        themeScheduleHint: '支持跨天时间段，例如 18:00 到 06:00。',
        themeSystemHint: '选择“跟随系统”时，会随操作系统外观变化自动切换。',
        ...
        homeContentHint:
          '自定义首页内容，支持 Markdown/HTML，也支持在受信任的管理员内容中使用内联 JavaScript（例如动态加载套餐）。如果输入的是链接（以 http:// 或 https:// 开头），则会使用该链接作为 iframe 的 src 属性，这允许你设置任意网页作为首页。设置后首页的状态信息将不再显示。',
      ...
      userRiskControl: {
        title: '用户转售风控',
        description: '配置疑似共享、转售或超售场景的观测、警告和自动锁定策略。',
        enabled: '启用风控',
        enabledHint: '关闭后保留历史档案，但不再执行新的每日评估。',
        warningEmailEnabled: '发送警告邮件',
        warningEmailEnabledHint: '当用户分数跌破阈值时，自动发送整改提醒。',
        requireTrustedProxy: '自动锁定要求可信代理',
        requireTrustedProxyHint: '开启后，只有存在可信公网来源证据时才允许自动锁定。',
        mode: '执行模式',
        modeObserveOnly: '仅观察',
        modeWarnOnly: '仅警告',
        modeAutoLock: '自动锁定',
        ...
        lockThreshold: '锁定阈值',
        badDays: '连续异常天数',
        overlapWindow: '并发重叠窗口（秒）',
        maxDistinctIPs: '单日最大公网 IP 数',
        highRiskActiveHours: '高风险活跃小时数',
        dailyPenaltyCap: '每日扣分上限',
        dailyRecovery: '每日恢复分值',
        retentionDays: '证据保留天数',
        warningEmailSubject: '警告邮件主题',
        warningEmailSubjectPlaceholder: '例如：账号使用异常提醒',
        lockMessage: '锁定提示文案',
        lockMessagePlaceholder: '例如：账号因疑似转售已被锁定，请联系管理员',
        saved: '用户转售风控设置保存成功',
        saveFailed: '保存用户转售风控设置失败'
      },
      billingFx: {
        title: '汇率缓存',
  ...
  payment: {
    ...
    errors: {
      ...
      PAYMENT_DISABLED: '支付系统暂未开启',
      USER_INACTIVE: '当前账号已被禁用，暂时无法支付',
      INVALID_PAYMENT_TYPE: '当前订单类型不支持所选支付方式',
      BALANCE_PAYMENT_DISABLED: '余额充值功能暂未开放',
      INVALID_AMOUNT: '支付金额不合法，请检查后重试',
      INVALID_INPUT: '支付请求参数不完整或不合法',
      PLAN_NOT_AVAILABLE: '所选订阅套餐暂不可购买',
      GROUP_NOT_FOUND: '所属订阅分组暂不可用',
      GROUP_TYPE_MISMATCH: '所选分组不是订阅分组',
      TOO_MANY_PENDING: '待支付订单过多（最多 {max} 个），请先完成或取消现有订单',
      CANCEL_RATE_LIMITED: '取消订单过于频繁，请稍后再试',
      DAILY_LIMIT_EXCEEDED: '今日充值额度已达上限，剩余可充值金额：{remaining}',
      NO_AVAILABLE_INSTANCE: '当前没有可用的支付通道，请稍后重试',
      PAYMENT_GATEWAY_ERROR: '支付网关暂时不可用，请稍后重试',
      PAYMENT_PROVIDER_MISCONFIGURED: '支付通道配置异常，请联系管理员处理',
      WXPAY_CONFIG_MISSING_KEY: '缺少必填项：{key}',
      WXPAY_CONFIG_INVALID_KEY_LENGTH: '{key} 长度不正确，应为 {expected}，当前为 {actual}',
      WXPAY_CONFIG_INVALID_KEY: '{key} 格式不正确，请检查 PEM 内容',
      NOT_FOUND: '未找到对应的支付订单',
      FORBIDDEN: '你没有权限执行这个支付操作',
      CONFLICT: '支付状态已发生变化，请刷新后重试',
      INVALID_ORDER_TYPE: '当前订单类型不支持该操作',
      INVALID_STATUS: '当前订单状态不允许执行该操作',
      BALANCE_NOT_ENOUGH: '退款金额超过可退余额',
      REFUND_AMOUNT_EXCEEDED: '退款金额超过订单可退范围',
      REFUND_FAILED: '退款失败，请稍后重试或联系管理员',
      USER_REFUND_DISABLED: '当前订单暂不支持用户自助退款',
      REFUND_DISABLED: '当前支付通道未开启退款能力',
      UPGRADE_SOURCE_INACTIVE: '原订阅已失效，暂时无法升级',
      UPGRADE_SOURCE_CHANGED: '原订阅套餐已发生变化，请重新选择升级方案',
      UPGRADE_ORDER_EXISTS: '该订阅已有未完成的升级订单，请先处理当前订单',
    },
    stripePay: '立即支付',
    ...
    planCard: {
      ...
      models: '模型',
      idleBilling: '闲时动态计费',
      idleWindow: '{start}-{end} 北京时间',
      idleRate: '闲时倍率',
      idleExtraProfit: '闲时盈利率',
    },
    days: '天',
    months: '个月',
    years: '年',
