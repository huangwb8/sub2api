    ...
    dashboard: {
      ...
      oversell: {
        ...
        tooltips: {
          ...
          residentialIpPrice: '按住宅代理供应商的计费口径填写单价，单位为 美元 / (GB*月)。系统会基于最近最多 14 天的非管理员活跃用户历史双向流量，自动折算住宅 IP 月成本并换算成人民币。',
        ...
        result: {
          ...
          residentialIpCostHint: '按近 {days} 天人均流量折算 · 约 {traffic} GB · {users} 人 · 汇率 {fx}',
