export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      oversell: {
        title: '套餐定价测算',
        description: '基于账号成本、住宅 IP 成本、用户消耗分布、目标盈利率和风险把握度，统一测算套餐达标售价与预测月利润。',
        ...
        tooltips: {
          ...
          residentialIpCost: '承载一个真实商品时额外配套的住宅 IP 月成本。若一个账号必须绑定住宅 IP 才能稳定工作，这项成本应和账号采购成本一起计入。',
