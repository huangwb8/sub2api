export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      recommendations: {
        title: '加号推荐',
        description: '基于近 30 天全站订阅画像、当前分组负载和实时容量，给管理员一个可解释的补号建议。',
        group: '分组 / 套餐',
        status: '状态',
        current: '当前账号',
        recommended: '建议账号',
        ...
        confidence: '置信度',
        reason: '推荐理由',
        groups: '评估 {count} 个订阅分组',
        toAdd: '建议新增 {count} 个号',
        urgent: '需优先处理 {count} 组',
        subscriptions: '{count} 个活跃订阅',
        addCount: '建议新增 {count} 个',
        noAction: '暂不需要加号',
        projectedCost: '预测日负载 ${amount}',
        empty: '当前没有可评估的订阅分组推荐。',
        statusMap: {
          healthy: '健康',
          watch: '观察',
          action: '行动'
