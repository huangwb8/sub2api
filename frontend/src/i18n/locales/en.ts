export default {
  ...
  nav: {
    ...
    accounts: 'Accounts',
    proxies: 'Proxies',
    schedulingMechanisms: 'Scheduling',
  ...
  auth: {
    ...
    turnstileInvalid: 'Verification expired. Please complete the verification again before signing in.',
  ...
  profile: {
    ...
    avatar: {
      ...
      generated: 'Generated',
      generatedDescription: 'Use a safe generated site avatar',
      uploaded: 'Upload',
      uploadedDescription: 'Use a local JPG, PNG, or WebP image',
      external: 'External URL',
      externalDescription: 'Use an existing CDN or image host URL',
      externalUrl: 'Avatar URL',
      uploadFile: 'Upload Image',
      uploadHint: 'JPG, PNG, or WebP. Maximum size is 1MB.',
      chooseFile: 'Choose Image',
      cropHint: 'Drag to reposition, then use zoom to frame a centered square avatar.',
      zoom: 'Zoom',
      applyCrop: 'Apply Crop',
      resetCrop: 'Recenter',
      recenter: 'Recenter',
      removeUpload: 'Remove Image',
      style: 'Generated Avatar Style',
      styleHint: 'This style is used whenever you switch back to generated avatars.',
      useGenerated: 'Use Generated',
      urlRequired: 'Please enter an avatar URL',
      fileRequired: 'Please choose an avatar image to upload',
      fileTooLarge: 'Avatar image must be 1MB or smaller',
      unsupportedFile: 'Avatar image must be JPG, PNG, or WebP',
      styles: {
        classicLetter: 'Classic Letter',
        classicLetterDesc: 'Clean default',
        auroraRing: 'Aurora Ring',
        auroraRingDesc: 'Soft glow',
        orbitBurst: 'Orbit Burst',
        orbitBurstDesc: 'Tech badge',
        pixelPatch: 'Pixel Patch',
        pixelPatchDesc: 'Textured',
        paperCut: 'Paper Cut',
        paperCutDesc: 'Layered'
      }
    },
  ...
  admin: {
    ...
    dashboard: {
      ...
      recommendations: {
        ...
        description: 'Uses the last 30 days of site-wide load and capacity-pool status to recommend schedulable account remediation.',
        pool: 'Capacity Pool',
        contributors: 'Plan Context',
        status: 'Status',
        current: 'Current Schedulable / Total',
        recommended: 'Recommended Schedulable',
        gap: 'Gap',
        utilization: 'Utilization',
        reason: 'Why',
        poolsAndGroups: '{pools} capacity pool(s) / {groups} subscription group(s) assessed',
        toAddSchedulable: 'Site-wide suggest adding {count} schedulable account(s)',
        recoverable: '{count} unschedulable account(s) can be recovered first',
        urgent: '{count} urgent pool(s)',
        subscriptions: '{count} active subscription(s)',
        addSchedulableCount: 'Add {count} schedulable account(s)',
        recoverableInline: 'Recoverable unschedulable: {count}',
        newAccountsInline: 'Estimated new accounts: {count}',
        noAction: 'No action needed',
        projectedCost: 'Projected daily load ${amount}',
        empty: 'No capacity pool recommendations are available yet.',
        statusMap: {
          healthy: 'Healthy',
          watch: 'Watch',
          action: 'Action'
      ...
      oversell: {
        ...
        form: {
          ...
          residentialIpPrice: 'Residential IP price',
        ...
        tooltips: {
          ...
          residentialIpPrice: 'Enter the supplier price in USD / (GB*month). The calculator applies it to the latest calibrated monthly residential IP traffic estimate and settles the result in CNY with the existing FX mechanism.',
        ...
        result: {
          ...
          residentialIpCost: 'Residential IP cost',
          minimumUsers: 'Modeled users',
          ...
          priceGapHint: 'Gap to required price {gap}',
          residentialIpTraffic: 'Needs {traffic} GB/month',
          residentialIpCostHint: 'Projected from per-user traffic over the last {days} calibrated days · about {traffic} GB · {users} users · FX {fx}',
          revenueHint: 'Revenue ¥{value}',
          costHint: 'Conservative cost ¥{value}',
          residentialIpScopeHint: 'Current scope: {scope} · Includes admin: {includesAdmin}',
          residentialIpCalibrationHint: 'Calibration {bytes} Bytes/token · Source {source}',
        ...
        residentialIpScopeTitle: 'Residential IP Dual Scope',
        residentialIpScopeDescription: 'The pricing scope is for package pricing, while the site scope reflects real infrastructure burn. Read them together so a pricing estimate is not mistaken for the real supplier bill.',
        reconciliationSummary: 'Latest reconciliation sample: platform estimate {estimated} GB vs supplier bill {supplier} GB, error {error}',
        scopePricing: 'Pricing Scope',
        scopeSite: 'Site Cost Scope',
        scopePricingDescription: 'Excludes admin traffic by default and focuses on successful user-facing requests for pricing and profit modeling.',
        scopeSiteDescription: 'Includes admin traffic so you can inspect the site’s recent real residential proxy cost.',
        scopeTraffic: 'Window traffic',
        scopeMonthlyCost: 'Monthlyized cost',
        scopeUsers: 'Users involved',
        scopeAdmin: 'Includes admin',
        scopeTrafficBasisHint: 'Traffic basis: {basis} · Calibration source: {calibration}',
        table: {
    ...
    users: {
      ...
      riskDialog: 'Risk Details',
      riskDialogTitle: 'Risk Details · {email}',
      riskScore: 'Risk Score',
      riskState: 'Risk State',
      riskBadDays: 'Consecutive Bad Days',
      riskLastWarned: 'Last Warning',
      riskSummary: 'Evaluation Summary',
      noRiskSummary: 'No risk summary yet',
      riskSignals: 'Recent Signals',
      riskTrustedIPs: 'Trusted Public IPs',
      riskUserAgents: 'UA Families',
      riskApiKeys: 'API Keys',
      riskOverlapEvents: 'Overlap Events',
      riskRecentIPs: 'Recent IPs',
      riskRecentUAs: 'Recent UAs',
      riskEvents: 'Risk Events',
      noRiskEvents: 'No risk events yet',
      riskRefresh: 'Refresh Details',
      riskActions: 'Admin Actions',
      riskActionsHint: 'These actions only affect the resale-risk profile and do not change balance, groups, or subscriptions.',
      riskActionReason: 'Action Note',
      riskActionReasonPlaceholder: 'For example: user explained this as team sharing, unlock and continue observing',
      riskExemptionToggle: 'Update Exemption State',
      riskExemptionToggleHint: 'Checked means exempted. Unchecked means remove the exemption.',
      riskSendWarning: 'Send Warning Email',
      riskUnlock: 'Unlock User',
      riskExempt: 'Save Exemption',
      riskRemoveExemption: 'Remove Exemption',
      riskResetScore: 'Reset Risk Score',
      riskWarningSent: 'Risk warning sent',
      riskUnlocked: 'Risk lock cleared',
      riskExemptionUpdated: 'Risk exemption updated',
      riskScoreReset: 'Risk score reset',
      riskFailedToLoad: 'Failed to load risk details',
      riskActionFailed: 'Failed to run risk action',
      riskStatuses: {
        healthy: 'Healthy',
        observed: 'Observed',
        warned: 'Warned',
    ...
    accounts: {
      ...
      types: {
        ...
        chatCompletionsDesc: 'Direct /v1/chat/completions passthrough',
      ...
      openai: {
        ...
        chatAPIResponsesEnabled: 'Serve Responses API too',
        chatAPIResponsesEnabledDesc:
          'When enabled, this ChatAPI account can also be scheduled for Responses API requests. Only enable this when the upstream proxy supports the Responses API format.',
    ...
    proxies: {
      ...
      accountNotes: 'Notes',
      accountTransferTarget: 'Move To IP',
      accountTransferPlaceholder: 'Select a target proxy',
      accountTransferUnavailable: 'No available proxy',
      accountTransferAction: 'Switch',
      accountTransferSuccess: 'Moved {account} to {proxy}',
      accountTransferFailed: 'Failed to switch account proxy',
      accountTransferOptionsFailed: 'Failed to load transfer targets',
      name: 'Name',
      protocol: 'Protocol',
      host: 'Host',
      port: 'Port',
      ...
      reliabilityTitle: 'Probe and Request Correlation',
      probeSuccessRate: 'Probe Success Rate',
      realSuccessCount: 'Successful Requests',
      afterFailureWindow: 'Successes within {minutes}m after failure',
      reliabilityHint: 'Probe failure is a risk signal, not proof that real requests will fail.',
      noReliabilityData: 'No probe correlation data yet',
      ...
      failoverSettingsSaveFailed: 'Failed to save proxy failover settings',
      failoverFields: {
    ...
    schedulingMechanisms: {
      ...
      proxyFailoverHint: 'Import the built-in rules first, then tune thresholds for your proxy pool.',
      saveProxyFailover: 'Save Proxy Failover',
      proxyFailoverSaved: 'Proxy auto-failover settings saved',
      importButton: 'Import Rules',
      importHint: 'You can directly import `docs/rules/调度机制.json`, or any compatible JSON rules file.',
      importSuccess: 'Scheduling mechanisms imported',
      importFailed: 'Failed to import scheduling mechanisms',
      saveFailed: 'Failed to save scheduling mechanisms',
      createButton: 'New Mechanism',
      createDialogTitle: 'Create Scheduling Mechanism',
      editDialogTitle: 'Edit Scheduling Mechanism',
      searchPlaceholder: 'Search by name, platform, or account type',
      showHidden: 'Show hidden mechanisms',
      enabled: 'Enabled',
      disabled: 'Disabled',
      hidden: 'Hidden',
      visible: 'Visible',
      hideAction: 'Hide',
      showAction: 'Unhide',
      mechanismSaved: 'Scheduling mechanism saved',
      mechanismDeleted: 'Scheduling mechanism deleted',
      mechanismHidden: 'Scheduling mechanism hidden',
      mechanismShown: 'Scheduling mechanism restored',
      backToProxies: 'Back to Proxies',
      ruleCount: '{count} rule(s)',
      emptyTitle: 'No scheduling mechanisms yet',
      emptyDescription: 'Import the built-in rules or create your own temporary unschedulable strategy.',
      columns: {
        name: 'Mechanism',
        scope: 'Scope',
        status: 'Status',
      ...
      fields: {
        ...
        autoTestEnabled: 'Automatic probing',
        probeIntervalMinutes: 'Probe interval (min)',
      ...
      form: {
        ...
        description: 'Description',
        rules: 'Temporary unschedulable rules',
        rulesHint: 'Separate keywords with commas. The rule triggers when the HTTP code matches and any keyword appears.',
        errorCode: 'HTTP status',
        durationMinutes: 'Cooldown minutes',
        keywords: 'Keywords',
        keywordsPlaceholder: 'bad gateway, upstream, overloaded',
        ruleDescription: 'Rule description',
        validationFailed: 'Please provide a mechanism name and at least one valid rule'
      },
      addRule: 'Add Rule'
    },
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        anthropicCacheTTL1hInjectionHint: 'When enabled, force `ttl: 1h` onto existing ephemeral cache blocks for Anthropic OAuth/Setup Token requests. Usage is still normalized back to 5m by default unless the account-level TTL billing override says otherwise.',
      },
      webSearchEmulation: {
        title: 'WebSearch Emulation',
        description: 'Configure global WebSearch emulation for Anthropic API Key traffic. It stays off by default until explicitly enabled.',
        enabled: 'Enable WebSearch Emulation',
        enabledHint: 'Only applies when the request contains only the WebSearch tool, so existing normal forwarding behavior remains untouched.',
        providers: 'Search Providers',
        addProvider: 'Add Provider',
        noProviders: 'No search providers configured yet',
        ...
        copied: 'Copied',
        quotaLimit: 'Quota Limit',
        quotaLimitHint: 'Leave empty for unlimited quota; when set, usage is tracked against the monthly quota.',
        quotaLimitMustBePositive: 'Quota limit must be a positive integer, or empty for unlimited.',
        subscribedAt: 'Subscription Start Date',
        subscribedAtHint: 'Used to calculate the monthly quota reset cycle.',
        expiresAt: 'Expires At',
        quotaUsage: 'Quota Used',
        resetUsage: 'Reset Usage',
        resetUsageConfirm: 'Reset this provider usage back to 0?',
        resetUsageSuccess: 'Usage reset successfully',
        proxy: 'Attached Proxy',
        test: 'Test',
        testing: 'Testing...',
        testResultTitle: 'WebSearch Test Result',
        testResultProvider: 'Selected Provider',
        testNoResults: 'No search results returned',
      ...
      site: {
        ...
        appearanceDescription: 'Configure the theme behavior for this browser across admin and public pages',
        themeMode: 'Theme Mode',
        themeModeHint: 'Changes take effect immediately and are saved in this browser.',
        themeModeSystem: 'Follow System',
        themeModeLight: 'Light Mode',
        themeModeDark: 'Dark Mode',
        themeModeSchedule: 'Scheduled',
        themeDarkStart: 'Dark Starts',
        themeDarkEnd: 'Dark Ends',
        themeScheduleHint: 'Overnight ranges are supported, for example 18:00 to 06:00.',
        themeSystemHint: 'Follow System updates automatically when your operating system appearance changes.',
        ...
        homeContentHint: 'Customize the home page content. Supports Markdown/HTML, and trusted admin-authored inline JavaScript for dynamic sections such as plan loading. If you enter a URL (starting with http:// or https://), it will be used as an iframe src to embed an external page. When set, the default status information will no longer be displayed.',
      ...
      userRiskControl: {
        title: 'User Resale Risk Control',
        description: 'Configure observe, warn, and auto-lock policies for suspicious sharing, resale, or oversell behavior.',
        enabled: 'Enable risk control',
        enabledHint: 'Turning this off keeps historical records but stops new daily evaluations.',
        warningEmailEnabled: 'Send warning email',
        warningEmailEnabledHint: 'Automatically notify users when their score drops below the warning threshold.',
        requireTrustedProxy: 'Require trusted proxy evidence for auto-lock',
        requireTrustedProxyHint: 'When enabled, auto-lock only triggers if trusted public-IP evidence exists.',
        mode: 'Execution mode',
        modeObserveOnly: 'Observe only',
        modeWarnOnly: 'Warn only',
        modeAutoLock: 'Auto lock',
        warningThreshold: 'Warning threshold',
        lockThreshold: 'Lock threshold',
        badDays: 'Consecutive bad days',
        overlapWindow: 'Overlap window (seconds)',
        maxDistinctIPs: 'Max public IPs per day',
        highRiskActiveHours: 'High-risk active hours',
        dailyPenaltyCap: 'Daily penalty cap',
        dailyRecovery: 'Daily recovery score',
        retentionDays: 'Evidence retention days',
        warningEmailSubject: 'Warning email subject',
        warningEmailSubjectPlaceholder: 'For example: Unusual account usage warning',
        lockMessage: 'Lock message',
        lockMessagePlaceholder: 'For example: Your account has been locked for suspected resale. Contact the administrator.',
        saved: 'User resale risk settings saved',
        saveFailed: 'Failed to save user resale risk settings'
      },
      billingFx: {
        title: 'FX Cache',
  ...
  payment: {
    ...
    errors: {
      ...
      PAYMENT_DISABLED: 'The payment system is currently disabled.',
      USER_INACTIVE: 'Your account is disabled and cannot create payments right now.',
      INVALID_PAYMENT_TYPE: 'The selected payment method is not available for this order type.',
      BALANCE_PAYMENT_DISABLED: 'Balance top-up is currently unavailable.',
      INVALID_AMOUNT: 'The payment amount is invalid. Please review it and try again.',
      INVALID_INPUT: 'The payment request is incomplete or invalid.',
      PLAN_NOT_AVAILABLE: 'The selected subscription plan is not available for purchase.',
      GROUP_NOT_FOUND: 'The related subscription group is no longer available.',
      GROUP_TYPE_MISMATCH: 'The selected group is not a subscription group.',
      ...
      DAILY_LIMIT_EXCEEDED: 'The daily top-up limit has been reached. Remaining top-up amount: {remaining}',
      NO_AVAILABLE_INSTANCE: 'No payment channel is currently available. Please try again later.',
      PAYMENT_GATEWAY_ERROR: 'The payment gateway is temporarily unavailable. Please try again later.',
      PAYMENT_PROVIDER_MISCONFIGURED: 'The payment channel is misconfigured. Please contact an administrator.',
      WXPAY_CONFIG_MISSING_KEY: 'Missing required field: {key}',
      WXPAY_CONFIG_INVALID_KEY_LENGTH: '{key} has an invalid length. Expected {expected}, got {actual}.',
      WXPAY_CONFIG_INVALID_KEY: '{key} is invalid. Please check the PEM content.',
      NOT_FOUND: 'The requested payment order could not be found.',
      FORBIDDEN: 'You do not have permission to perform this payment action.',
      CONFLICT: 'The payment state has changed. Please refresh and try again.',
      INVALID_ORDER_TYPE: 'This action is not supported for the current order type.',
      INVALID_STATUS: 'This action is not allowed in the current order status.',
      BALANCE_NOT_ENOUGH: 'The refund amount exceeds the refundable balance.',
      REFUND_AMOUNT_EXCEEDED: 'The refund amount exceeds the refundable amount for this order.',
      REFUND_FAILED: 'Refund failed. Please try again later or contact an administrator.',
      USER_REFUND_DISABLED: 'Self-service refunds are not available for this order.',
      REFUND_DISABLED: 'Refunds are not enabled for this payment channel.',
      UPGRADE_SOURCE_INACTIVE: 'The source subscription is no longer active and cannot be upgraded.',
      UPGRADE_SOURCE_CHANGED: 'The source subscription plan has changed. Please choose an upgrade option again.',
      UPGRADE_ORDER_EXISTS: 'There is already an unfinished upgrade order for this subscription.',
    },
    stripePay: 'Pay Now',
    ...
    planCard: {
      ...
      unlimited: 'Unlimited',
      models: 'Models',
      idleBilling: 'Off-peak dynamic billing',
      idleWindow: '{start}-{end} Beijing time',
      idleRate: 'Off-peak rate',
      idleExtraProfit: 'Off-peak margin',
    },
    days: 'days',
    months: 'months',
    years: 'years',
