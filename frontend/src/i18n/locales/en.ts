    ...
    dashboard: {
      ...
      oversell: {
        ...
        tooltips: {
          ...
          residentialIpPrice: 'Enter the supplier price in USD / (GB*month). The calculator converts the latest up-to-14-day non-admin active-user bidirectional traffic into a monthly residential IP cost and settles it in CNY with the existing FX mechanism.',
        ...
        result: {
          ...
          residentialIpCostHint: 'Projected from per-user traffic over {days} days · about {traffic} GB · {users} users · FX {fx}',
