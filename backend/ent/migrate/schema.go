...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "plugin_settings", Type: field.TypeJSON},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "idle_rate_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "extra_profit_rate_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "idle_extra_profit_rate_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "idle_start_seconds", Type: field.TypeInt, Nullable: true},
		{Name: "idle_end_seconds", Type: field.TypeInt, Nullable: true},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "upgrade_credit_cny", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "upgrade_payable_cny", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "upgrade_remaining_ratio", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "upgrade_family", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "upgrade_rank", Type: field.TypeInt, Default: 0},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "proxy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "used_residential_proxy", Type: field.TypeBool, Nullable: true},
		{Name: "proxy_traffic_input_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "proxy_traffic_output_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "proxy_traffic_overhead_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "proxy_traffic_estimate_source", Type: field.TypeString, Nullable: true, Size: 64},
		...
		{Name: "fx_safety_margin", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,6)"}},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "avatar_style", Type: field.TypeString, Size: 32, Default: "classic_letter"},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "current_plan_id", Type: field.TypeInt64, Nullable: true},
		{Name: "current_plan_name", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "current_plan_price_cny", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "current_plan_validity_days", Type: field.TypeInt, Nullable: true},
		{Name: "current_plan_validity_unit", Type: field.TypeString, Size: 10, Default: ""},
		{Name: "billing_cycle_started_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
