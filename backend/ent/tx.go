...
func (tx *Tx) init() {
	...
	tx.ProxyProbeLog = NewProxyProbeLogClient(tx.config)
	...
	tx.UserRiskEvent = NewUserRiskEventClient(tx.config)
	tx.UserRiskProfile = NewUserRiskProfileClient(tx.config)
