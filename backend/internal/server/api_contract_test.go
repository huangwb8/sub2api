			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.dashboardRecommendationService.oversellResponse = &service.DashboardOversellCalculatorResponse{
					...
					Estimate: service.DashboardOversellEstimate{
						...
						ResidentialIPFXRateSource:       "fallback_floor",
						ResidentialIPTrafficBasis:       "最近 14 天经代理账号的成功请求 token 体量按约 4 Bytes/token 折算双向流量",
					},
			...
			wantJSON: `{
				...
				"data": {
					...
					"estimate": {
						...
						"residential_ip_traffic_basis": "最近 14 天经代理账号的成功请求 token 体量按约 4 Bytes/token 折算双向流量"
					},
					"result": {
						"feasible": true,
						"minimum_users": 12,
