...
func UserFromServiceAdmin(u *service.User) *AdminUser {
	...
	return &AdminUser{
		User:                          *base,
		Notes:                         u.Notes,
		TemporaryInvitation:           u.TemporaryInvitation,
		TemporaryInvitationDeadlineAt: u.TemporaryInvitationDeadlineAt,
		TemporaryInvitationDisabledAt: u.TemporaryInvitationDisabledAt,
		TemporaryInvitationDeleteAt:   u.TemporaryInvitationDeleteAt,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	availability := a.EffectiveAvailability(time.Now())
	out := &Account{
		ID:                        a.ID,
		Name:                      a.Name,
		Notes:                     a.Notes,
		...
		ActualCostCNY:             a.ActualCostCNY,
		ActualCostUsageUSD:        a.ActualCostUsageUSD,
		ActualCostUpdatedAt:       a.ActualCostUpdatedAt,
		Status:                    a.Status,
		ErrorMessage:              a.ErrorMessage,
		EffectiveStatus:           availability.Status,
		EffectiveStatusReason:     availability.Reason,
		...
		EffectiveRateLimitResetAt: availability.EffectiveRateLimitAt,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		ChargedAmountCNY:      l.ChargedAmountCNY,
		EstimatedCostCNY:      l.EstimatedCostCNY,
		FXRateUSDCNY:          l.FXRateUSDCNY,
		FXRateSource:          l.FXRateSource,
		FXFetchedAt:           l.FXFetchedAt,
		FXSafetyMargin:        l.FXSafetyMargin,
