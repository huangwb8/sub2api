...
type CreateAccountRequest struct {
	...
	Type                    string         `json:"type" binding:"required,oneof=oauth setup-token apikey chatapi upstream bedrock"`
...
type UpdateAccountRequest struct {
	...
	Notes                   *string        `json:"notes"`
	Type                    string         `json:"type" binding:"omitempty,oneof=oauth setup-token apikey chatapi upstream bedrock"`
