...
func (r *apiKeyRepository) Create(ctx context.Context, key *service.APIKey) error {
	builder := r.client.APIKey.Create().
		...
		SetPluginSettings(key.PluginSettings).
		SetQuota(key.Quota).
...
func apiKeyEntityToService(m *dbent.APIKey) *service.APIKey {
	...
	out := &service.APIKey{
		...
		PluginSettings: m.PluginSettings,
...
func userEntityToService(u *dbent.User) *service.User {
	...
	return &service.User{
		...
		AvatarType:                    service.AvatarTypeOrDefault(u.AvatarType),
		AvatarStyle:                   service.AvatarStyleOrDefault(u.AvatarStyle),
		Notes:                         u.Notes,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		IdleStartSeconds:                g.IdleStartSeconds,
		IdleEndSeconds:                  g.IdleEndSeconds,
